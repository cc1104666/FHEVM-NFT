...
function readDeployment(chainName, chainId, contractName, optional) {
  ...
  if (!fs.existsSync(deploymentFile)) {
    if (!optional) {
      console.error(`${line}Unable to locate '${deploymentFile}' file.${line}`);
      process.exit(1);
    }
    return undefined;
  }
